...
# LAUNCH
# blender --background --python exportSceneGltf.py "TEXT" "MAT" "FONT"

# TODO utiliser argparse pour améliorer la lisibilité
# CONFIGURATION
TEXT = sys.argv[1:][3]
MAT = sys.argv[1:][4]
FONT = sys.argv[1:][5]
...
materialPath = f"C:/Users/seeds/PycharmProjects/simpleApi/sceneGenerator/materials/{MAT}"
COLOR_PATH = materialPath + "/color.jpg"
METALNESS_PATH = materialPath + "/metalness.jpg"
ROUGHNESS_PATH = materialPath + "/roughness.jpg"
DISPLACEMENT_PATH = materialPath + "/displacement.jpg"
HDRI_PATH = "C:/Users/seeds/PycharmProjects/simpleApi/sceneGenerator/hdri/pizzo_pernice_4k.exr"
...
displacement.image = bpy.data.images.load(DISPLACEMENT_PATH)
...
envTexture.image = bpy.data.images.load(HDRI_PATH)
